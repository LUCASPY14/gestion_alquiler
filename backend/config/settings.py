...
TIME_ZONE = env('TIME_ZONE', default='America/Asuncion')
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        ...
        'alquiler.permissions.EsPropietarioOStaff',
    ),
...
# CORS (frontend en Vite corre en :5173 por defecto)
